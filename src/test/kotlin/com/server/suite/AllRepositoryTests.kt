...
@RunWith(Suite::class)
@SuiteClasses(AccessTokenRepositoryTest::class, RefreshTokenRepositoryTest::class, UserRepositoryTest::class, ClientRepositoryTest::class, AuthorizationCodeRepositoryTest::class)
